...
- 🗼 **PoE 2 先祖塔台與生態群落策略優化器**：
  先祖石塔多塔輻射交疊增益（雙塔 +15%、三塔 +35% 共振加乘），先祖碑牌 (Precursor Tablets) 效益聚合與六大生態群落最佳化推薦。
...
本專案遵循嚴格的軟體工程標準，目前全專案共有 **1145+ 項自動化單元測試** 全數通過：

```bash
# 執行前端 Vitest 單元測試 (233 個測試檔，1059 項測試)
npm test
