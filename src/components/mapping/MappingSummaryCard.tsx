...
export const MappingSummaryCard: React.FC<MappingSummaryCardProps> = ({ stats }) => {
  ...
  return (
    ...
    >
      <div className="poe-card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      <div className="poe-card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', border: '1px solid rgba(243, 209, 121, 0.4)' }}>
