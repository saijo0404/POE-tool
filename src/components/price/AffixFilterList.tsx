...
export const AffixFilterList: React.FC<AffixFilterListProps> = ({
  ...
  itemLevelMin, setItemLevelMin, onToggleMod, onChangeMinValue, onChangeMaxValue,
  ...
  return (
    <div className="poe-card" style={{ marginBottom: '20px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', padding: '10px 14px', background: 'rgba(0, 0, 0, 0.25)', borderRadius: '6px', marginBottom: '14px', alignItems: 'center' }}>
        {setTradeStatus && (
