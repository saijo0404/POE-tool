...
pub use path_resolver::{
    get_exe_dir, get_fallback_log_paths, get_primary_log_path, open_or_create_writable_log,
};
pub use rotator::{
...
pub use writer::{
    clear_logs, get_current_log_path, get_diagnostic_bundle, init_logger, log_entry, log_to_file,
    read_recent_logs,
};
